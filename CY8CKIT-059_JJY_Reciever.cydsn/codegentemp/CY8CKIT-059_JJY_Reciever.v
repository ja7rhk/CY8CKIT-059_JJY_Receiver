// ======================================================================
// CY8CKIT-059_JJY_Reciever.v generated from TopDesign.cysch
// 02/13/2020 at 13:06
...
module I2C_v3_50_0 (
	...
	cy_clock_v1_0
		#(.id("321bd200-1dc0-443b-af85-5d14aab9ed87/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module WaveDAC8_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("025c1ac6-01e6-4087-bd24-bae11bd92df8/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("12500000000"),
		  .is_direct(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=4, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=999900, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG24, CySetRegReplacementString=CY_SET_REG24, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=1000000, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=false, Resolution=24, RunMode=0, UDB16=false, UDB24=true, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC24, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Counter_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Counter_1, CY_INSTANCE_SHORT_NAME=Counter_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Counter_1, )
...
module top ;
    ...
    CyControlReg_v1_80 TONE_Control_Reg (
        .control_1(Net_246),
        .control_2(Net_247),
        .control_3(Net_248),
        .control_0(Net_232),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam TONE_Control_Reg.Bit0Mode = 0;
    defparam TONE_Control_Reg.Bit1Mode = 0;
    defparam TONE_Control_Reg.Bit2Mode = 0;
    defparam TONE_Control_Reg.Bit3Mode = 0;
    defparam TONE_Control_Reg.Bit4Mode = 0;
    defparam TONE_Control_Reg.Bit5Mode = 0;
    defparam TONE_Control_Reg.Bit6Mode = 0;
    defparam TONE_Control_Reg.Bit7Mode = 0;
    defparam TONE_Control_Reg.BitValue = 0;
    defparam TONE_Control_Reg.BusDisplay = 0;
    defparam TONE_Control_Reg.ExtrReset = 0;
    defparam TONE_Control_Reg.NumOutputs = 1;
	...
	wire [0:0] tmpOE__TC_IN_net;
	wire [0:0] tmpIO_0__TC_IN_net;
	wire [0:0] tmpINTERRUPT_0__TC_IN_net;
	electrical [0:0] tmpSIOVREF__TC_IN_net;
	...
	cy_psoc3_pins_v1_10
		...
		TC_IN
		 (.oe(tmpOE__TC_IN_net),
		  .y({1'b0}),
		  .fb({Net_594}),
		  .io({tmpIO_0__TC_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__TC_IN_net),
		  .interrupt({tmpINTERRUPT_0__TC_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TC_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Counter_1.Resolution = 24;
    ...
    CyControlReg_v1_80 JJY_Control_Reg (
        .control_1(Net_775),
        .control_2(Net_776),
        .control_3(Net_777),
        .control_0(Net_805),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam JJY_Control_Reg.Bit0Mode = 0;
    defparam JJY_Control_Reg.Bit1Mode = 0;
    defparam JJY_Control_Reg.Bit2Mode = 0;
    defparam JJY_Control_Reg.Bit3Mode = 0;
    defparam JJY_Control_Reg.Bit4Mode = 0;
    defparam JJY_Control_Reg.Bit5Mode = 0;
    defparam JJY_Control_Reg.Bit6Mode = 0;
    defparam JJY_Control_Reg.Bit7Mode = 0;
    defparam JJY_Control_Reg.BitValue = 0;
    defparam JJY_Control_Reg.BusDisplay = 0;
    defparam JJY_Control_Reg.ExtrReset = 0;
    defparam JJY_Control_Reg.NumOutputs = 1;


	cy_clock_v1_0
		#(.id("86ebcfcf-9c7c-46de-a145-0c72eca7e58a"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_232 or Net_594 or Net_805)
        begin
            case (Net_805)
                1'b0 :  tmp__mux_1_reg = Net_232;
                1'b1 :  tmp__mux_1_reg = Net_594;
            endcase
        end
        assign Net_640 = tmp__mux_1_reg;
    end
    // -- Mux end --


	cy_clock_v1_0
		#(.id("b7156767-3d18-4f05-9b42-afd9405ca38e"),
		  .source_clock_id(""),
		  .divisor(0),
